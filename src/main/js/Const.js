//REST API
export const REST_SERVER = 'http://localhost:8080'
export const REST_API_URL = REST_SERVER + '/api'
export const REST_MOVIES_RES = REST_API_URL + '/movies/';
export const GET_REST_MY_MOVIES_URL = REST_MOVIES_RES + 'curMovies';
export const POST_REST_MY_MOVIES_URL = REST_MOVIES_RES;
export const SEARCH_REST_MOVIES_BY_TMDBID_URL = REST_MOVIES_RES + 'movieByTmdbIdOfCurUser?tmdbId=';
...
// WEB SOCKET
export const WEBSOCKET_URL = REST_SERVER + '/newReviews/';
