...
class Reviews extends Component {
    render() {
    	// !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !!
    	// !!! NOTE THAT REVIEW STATE IS KEPT IN MAIN.JS FOR PROPER SYNC WITH
      // WEBSOCKET !!
    	// !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !! !!!!!! !!
    	const header = function(time, user) {
    		return <div>
        ...
        return (
            <div>
               ...
               {this.props.reviews.map(review => {
            	   ...
            	   return (
            	     <li className="review" key={review.tmdbId}>
            	       <Card title={review.title + " (" + review.year + ")"} 
            	             style={{width: '600px'}} className="ui-card-shadow"
            	             header={header(review.modifiedTime, review.user)}>
                         <div>
                           <table>
                             <tbody>
                               <tr>
